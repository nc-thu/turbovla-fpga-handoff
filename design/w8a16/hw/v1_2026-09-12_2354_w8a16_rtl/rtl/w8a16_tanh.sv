...
// The input/output scale is Q1.15.  The four segments avoid a floating-point
// divider while keeping monotonicity and exact saturation at the endpoints.
...
module w8a16_tanh #(parameter int N = 16) (
  ...
  always_comb begin
    ...
    for (i = 0; i < N; i = i + 1) begin
      ...
      else if (ax >= 16'sd16384) yi = 24576 + ((ax - 16384) * 8191) / 8192;
      else if (ax >= 16'sd8192) yi = 12288 + ((ax - 8192) * 12287) / 8192;
      else yi = (ax * 3) / 2;
      if (x[i*16 + 15]) yi = -yi;
