...
module tb_replay_top;
  ...
  initial begin
    ...
    $display("ACTIVITY total=%0d mapped=%0d fallback=%0d active=%0d mac=%0d tiles=%0d output_bytes=%0d queue_max=%0d", activity_snapshot[63:0], activity_snapshot[127:64], activity_snapshot[191:128], activity_snapshot[703:640], activity_snapshot[831:768], activity_snapshot[895:832], activity_output_bytes, activity_queue_max_occupancy);
    if (activity_snapshot[63:0] != 64'd155780495) $fatal(1, "total cycle mismatch");
    if (activity_snapshot[127:64] != 64'd149359343) $fatal(1, "mapped cycle mismatch");
    if (activity_snapshot[191:128] != 64'd6421152) $fatal(1, "fallback cycle mismatch");
    if (activity_snapshot[831:768] != 64'd49584342528) $fatal(1, "MAC mismatch");
    if (activity_snapshot[895:832] != 64'd75487) $fatal(1, "tile mismatch");
    if (activity_output_bytes != 64'd159228360) $fatal(1, "output bytes mismatch");
