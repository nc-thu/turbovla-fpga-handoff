// Micro-instruction sequencer for tvla_w8a16.isa.v1.
// The 64-bit transport word carries opcode, flags, three addresses and a
// length.  M/N/K and scale IDs live in the compiler descriptor sideband; the
// sequencer waits for the selected unit to acknowledge completion.
