# TurboVLA W8A16 v7: 250 MHz post-route implementation.
#
# This is an independent non-project run.  The v7 RTL keeps v6's DSP pipeline
# and additionally partitions the high-fanout array clear control.  No bitstream
# is requested because this wrapper has no board pin, DDR, or clock-buffer
# constraints.
# Usage:
