...
module w8a16_softmax #(parameter int N = 16) (
  ...
  typedef enum logic [3:0] {S_IDLE, S_MAX, S_EXP, S_NORM, S_NUM_BUILD, S_DIV, S_SATURATE, S_WRITEBACK, S_EMIT} state_t;
  state_t state;
