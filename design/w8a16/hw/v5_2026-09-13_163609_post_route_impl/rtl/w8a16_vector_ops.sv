// Command wrapper for the non-GEMM vector instructions.  Simple element-wise
// operations retire in one command cycle; registered MUL_SCALE, tanh,
// LayerNorm and Softmax retain their multi-cycle handshakes.
