...
v3 在 LayerNorm/Softmax 的最后除法位之后增加 `S_SATURATE` 状态，再写输出寄存器。Vivado 2021.2 对 3.298 ns 目标报告系统 top WNS +0.067 ns、数据路径 3.220 ns；这是逻辑综合估算，尚未经过 place/route。
