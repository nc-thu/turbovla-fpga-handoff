"""TurboVLA W8A16 v4 16×48 cycle and traffic model.
...
DATA = WORK_ROOT / "data" / "v4_2026-09-13_150700"
...
def build() -> list[dict[str, Any]]:
    ...
    (DATA / "cycle_breakdown.json").write_text(json.dumps({"schema_version": "tvla_w8a16.cycles.v4", "rows": rows}, indent=2), encoding="utf-8")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="build the v4 W8A16 tile cycle model")
