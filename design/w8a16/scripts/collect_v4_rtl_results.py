...
HW = ROOT / "hw" / "v4_2026-09-13_150700_w8a16_timing_fixed_rtl"
LOG = HW / "sim" / "logs"
RTL = HW / "rtl"
...
def main() -> None:
    ...
    result = {
        "schema_version": "tvla_w8a16.rtl_results.v4",
        "generated_at": datetime.now(timezone.utc).isoformat(timespec="seconds"),
        "server_experiment": "/tmp/tvla_v4_timingfix_20260913_150700",
        ...
        "tests": {
            ...
            "iverilog_runtime": pass_log("iverilog_runtime.log"),
        },
