...
module tb_pack2_mult_padd;
  ...
  wire v_p, row_p;
  wire signed [7:0] a_p;
  // Use the timing-version primitive directly.  The old wrapper remains in
  // the v1 directory; this test must exercise the new RTL copy.
  pack2_mult_padd #(.M_REG(1), .P_REG(1)) dut (
