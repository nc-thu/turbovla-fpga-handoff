# Independent synthesis after replacing the package DMA zero-fill tie-off
# with the tagged host payload stream (host_in_kind=7 / host_out_kind=2,3).
set root "V:/turbovla_w8a8_pack2/hw/v7_2026-09-16_073705_dma_burst_memory_rtl"
set script_dir "$root/vivado"
set out_dir "$script_dir/v7_synth_payload_20260916_0832"
file mkdir $out_dir
...
write_checkpoint -force "$out_dir/v7_payload_synth.dcp"
close_design
exit
